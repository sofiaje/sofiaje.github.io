...
const Oneproject = () => {
    ...
    let { id } = useParams();
    const { name, body, github, webpage, tech, image } = projects[id]
        ...
        <section>
            <div className="contentWrapper">
                ...
                <m.div initial={{ y: 50 }} whileInView={{ y: 0 }} transition={{ duration: 0.75, ease: "easeOut" }}>
                    ...
                    {image && <img src={process.env.PUBLIC_URL + image}></img>}
